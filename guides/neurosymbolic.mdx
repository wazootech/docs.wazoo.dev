...
For fully local embeddings without an API key, import
`UniversalSentenceEncoderEmbeddingService` from `@worlds/sdk/tfjs-use` — it
bundles the TF.js Universal Sentence Encoder lite model with a vendored
tokenizer.

...
<Steps>
  ...
  <Step title="Compose the sub-wikis in wiki.yml">
    ...
    <Note>
      ...
      [wiki install](https://wiki.wazoo.dev/wiki_install.md)
      and
      [External data sources (`sources:`)](https://wiki.wazoo.dev/Wiki_Configuration.md#external-data-sources-sources).
      For the product framing, see
      [Recursive Semantic Datasets](https://wiki.wazoo.dev/Recursive_Semantic_Datasets.md).
    </Note>
  ...
  <Step title="Query the composed corpus with per-source provenance">
    ...
    <Note>
      ...
      [wiki graph](https://wiki.wazoo.dev/wiki_graph.md).
    </Note>

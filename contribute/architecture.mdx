...
Wazoo separates platform management from graph data operations. The Platform API
manages organizations, groups, world metadata, tokens, and usage. The Worlds
Data API handles graph operations such as RDF import, RDF export, search, and
SPARQL.
...
manages organizations, groups, world records, tokens, and usage.

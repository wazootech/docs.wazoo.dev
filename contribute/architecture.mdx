...
- Platform management: Use the [Platform API](/platform/api) or `@wazoo/api` to
  ...
  usage records.
- Billing and limits: Usage and limits are billed by compute time. Stripe is the
  source of truth for billing and subscription state.
...
and D1. Worlds data-plane packages are published separately and may target

...
Hono and D1 for metadata. It currently records organizations, worlds, tokens,
and usage. The full production provisioning flow between platform metadata and
data-plane services is still evolving.

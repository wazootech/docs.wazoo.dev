...
The Wazoo Platform API is the management API for hosted Wazoo resources. It is
separate from the Worlds Data API.

Use the Platform API to create and inspect organizations, groups, world
metadata, platform tokens, world auth tokens, and usage records. Use the Worlds
Data API for graph operations such as search, SPARQL, import, and export.

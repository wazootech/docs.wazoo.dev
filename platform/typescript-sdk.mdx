...
`@wazoo/client` is the primary TypeScript SDK for the Wazoo Platform API. It
provides a clean, typed interface for managing your Wazoo infrastructure:
provisioning Worlds, managing API tokens (`wzp_` and `wzw_`), and tracking
...
`@hey-api/client-fetch` instance. Set `throwOnError: true` if you prefer

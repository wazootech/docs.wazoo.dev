...
provides a typed interface for managing your Wazoo infrastructure: provisioning
Worlds, managing API tokens (`wzp_` and `wzw_`), and tracking resource usage and
billing.

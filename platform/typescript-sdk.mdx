...
world auth tokens, and usage. Use `@worlds/client` for import, export, search,
SPARQL, and graph updates.
...
Usage records reflect what the Platform API knows today. Data-plane limit
enforcement is a separate integration point.

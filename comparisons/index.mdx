...
| [Cognee](/comparisons/cognee)                             | Extracted graph + vector memory | Graph traversal + similarity            | Extraction-derived       | Self-host or cloud     |
...
| [Graphiti](/comparisons/graphiti)                         | Temporal knowledge graph        | Hybrid semantic, keyword & graph search | Bi-temporal edge windows | Self-host or Zep Cloud |

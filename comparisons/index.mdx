...
| [Relational databases](/comparisons/relational-databases) | Tables and rows                 | SQL                           | Your schema        | You run it or cloud   |
...
rather than a direct alternative. Relational databases and the other
[storage families](/comparisons/relational-databases) complement Worlds rather
than compete with it: they hold the source of record, and Worlds holds the
distilled facts agents act on.

...
| How facts enter | Curated import          | Session capture       |
...
- You want a zero-dependency, drop-in library for a coding assistant today.
- Recalling past work by similarity is the whole job.
- You do not want to design a graph vocabulary.

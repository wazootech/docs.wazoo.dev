...
The LLM Wiki pattern (popularized by Andrej Karpathy and demonstrated in project
Farzapedia) and Wazoo Worlds take the same position on agent memory: it should
be compiled, structured, and interlinked rather than stored as flat, opaque
vector databases.
...
we recommend pairing your LLM Wiki with [Wazoo Worlds](/projects/worlds) as the

...
Both [Google Search](https://developers.google.com/custom-search) and Worlds
Worlds are built on the same premise: structured knowledge graphs answer queries
better than keyword strings alone ("things, not strings").

...
the same core realization: that standard CommonMark files with valid W3C JSON-LD
/ YAML-LD frontmatter form the ideal open primitive for semantic Markdown and
...
[`wiki`](/projects/wiki) CLI toolchain out of the box.

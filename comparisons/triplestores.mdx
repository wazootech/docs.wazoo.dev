...
| Storage Substrate | LibSQL/Turso, Deno KV, Postgres, or Cloud            | Custom disk structures / RocksDB / Java storage    |
...
- You want lightweight, edge-ready storage adapters (LibSQL, Deno KV, Postgres)
  without managing a Java JVM cluster.

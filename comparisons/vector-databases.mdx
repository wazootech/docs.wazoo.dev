...
Vector databases (such as [Pinecone](https://www.pinecone.io), [Qdrant](https://qdrant.tech), or [pgvector](https://github.com/pgvector/pgvector)) answer "what is semantically similar?" They index embeddings

...
operational digital twin that binds enterprise data sources, transactional
pipelines, and user actions into business objects such as Aircraft, Supplier,
and Work Order. It is designed to serve human analysts, executives, and
enterprise workflows with heavy governance and integration.

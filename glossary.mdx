...
A stateful knowledge graph instance: an RDF store whose facts stay synced with a
hybrid search index that combines FTS5/BM25 keyword matching and vector
embeddings, fused via

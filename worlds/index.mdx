...
A world is a stateful knowledge graph engine that acts as an agent's verifiable
context.
...
To verify a fact, Worlds uses the SPARQL ASK query. This returns a deterministic
boolean answer and does not rely on probabilistic guessing. See
[Query](/worlds/query) for how SPARQL works with Worlds.

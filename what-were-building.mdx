...
<CardGroup cols={2}>
  ...
  <Card title="Validate" icon="shield-check" href="/projects/wiki">
    Wiki CLI checks links, frontmatter, shapes, and graph integrity before publish.
  </Card>
...
- If you maintain a wiki or docs vault, start with [Wiki CLI](/projects/wiki).

...
[`https://docs.wazoo.dev/skills/wazoo-memory/SKILL.md`](https://docs.wazoo.dev/skills/wazoo-memory/SKILL.md).

### Installation

Install the main Wazoo Memory Skill directly into your local agent environment:

```bash
npx skills add wazootech/docs.wazoo.dev@wazoo-memory -g -y
```

Or manually place
[`SKILL.md`](https://docs.wazoo.dev/skills/wazoo-memory/SKILL.md) inside
`.agents/skills/wazoo-memory/SKILL.md` (or `~/.gemini/config/skills/`).

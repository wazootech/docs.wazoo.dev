...
Wazoo projects are organized around verifiable context: representing knowledge,
validating it, storing it, and connecting it to agents.
...
<CardGroup cols={2}>
  <Card title="Worlds" icon="network" href="/projects/worlds">
    ...
    REST APIs, and edge-native storage.
  </Card>
  <Card title="Wiki" icon="book-open" href="/projects/wiki">
    Command-line tooling and templates for semantic Markdown wikis: validate,
    lint, query, render, build, and publish.
  </Card>
...
| ---------------------- | ----------------------------------------------------------------------- | -------------------------------------------- |
| Wazoo Platform SDK     | [wazoo-api-client-ts](https://github.com/wazootech/wazoo-api-client-ts) | TypeScript SDK for platform management       |
...
| Wiki                   | [wiki](https://github.com/wazootech/wiki)                               | Semantic Markdown wiki toolchain             |
...
Some Wazoo projects are private or experimental while product surfaces are still
changing. These docs focus on public repositories and stable concepts first,
then link into platform docs where appropriate.

The Platform API server is currently private. Its public SDK is
`wazoo-api-client-ts`.

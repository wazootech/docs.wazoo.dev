...
<CardGroup cols={2}>
  ...
  <Card title="Wiki CLI" icon="book-open" href="/projects/wiki">
    Command-line tooling for semantic Markdown wikis: validate, lint, query, render, build, and publish.
  </Card>
  ...
  <Card title="Templates" icon="copy" href="/projects/templates">
    Starter projects for Wiki CLI, LLM wikis, Mintlify, Next.js, Astro, Quartz, and SPARQL explorers.
  </Card>
</CardGroup>
...
| Wiki CLI | [wiki](https://github.com/wazootech/wiki) | Semantic Markdown wiki toolchain |

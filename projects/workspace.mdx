...
5. **Develop**:
   ...
   ```
6. **Sync local secrets**: `wspace env sync --dry-run` then `wspace env sync`
7. **Push and create pull request**:
   ```sh
   git push -u origin <feature>
   gh pr create
   ```
8. **Find merged worktrees**: `wspace worktree list --stale`
9. **Clean up**: `wspace worktree remove <repo> <feature>`

...
- [wazoo worlds import](./import.mdx): Import text, files, or RDF knowledge into
  a world
- [wazoo worlds export](./export.mdx): Export world graph quads/triples
- [wazoo worlds search](./search.mdx): Perform hybrid vector + SPARQL graph
  search across world memory
- [wazoo worlds sparql](./sparql.mdx): Execute raw SPARQL queries against a
  world graph
